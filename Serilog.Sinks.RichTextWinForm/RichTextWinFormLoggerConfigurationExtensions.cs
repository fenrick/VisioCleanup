...
public static class RichTextWinFormLoggerConfigurationExtensions
{
    ...
    /// <param name="outputTemplate">A message template describing the format used to write to the sink. The default is
    /// "[{Timestamp:HH:mm:ss} {Level:u3}] {Message:lj}{NewLine}{Exception}".</param>
