...
namespace Serilog.Sinks.WinForm
{
    ...
    public class FixedQueue<T> : Queue<T>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="FixedQueue{T}"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="FixedQueue{T}"/> class. With a default capacity of 50.
        /// </summary>
        public FixedQueue()
